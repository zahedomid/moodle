...
$string['zone'] = 'Zone';
$string['youareinthezone'] = 'You are in "{$a->name}".<br>You have not completed {$a->count} activities';
$string['usersinthezone'] = '{$a->count} users are in "{$a->zone}".';
$string['greenzone'] = 'Green zone';
$string['yellowzone'] = 'Yellow zone';
$string['orangezone'] = 'Orange zone';
$string['redzone'] = 'Red zone';
$string['perfect'] = 'Perfect';
$string['warning'] = 'Warning';
$string['alert'] = 'Alert';
$string['danger'] = 'Danger';
$string['by_user_role'] = 'Show by role';