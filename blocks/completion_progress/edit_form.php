...
class block_completion_progress_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('select', 'config_count_roles', get_string('by_user_role', 'block_completion_progress'), $roles);
        if ($student_role = current(get_archetype_roles('student'))) {
            $mform->setDefault('config_count_roles', $student_role->id);
        }
        $mform->getElement('config_count_roles')->setMultiple(true);
        $mform->setAdvanced('config_count_roles', true);
        ...
        $module_list = array_merge(
            ...
            block_completion_progress_mods_list($COURSE->id)
        );
        $mform->addElement('select', 'config_count_module', get_string('activity'), $module_list);
        $mform->setAdvanced('config_count_module', true);
