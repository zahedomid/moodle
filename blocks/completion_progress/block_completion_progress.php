    ...
    public function get_content()
    {
        ...
        if (block_completion_progress_on_site_page()) {
            ...
            if (has_capability('block/completion_progress:showbar', $this->context)) {
                ...
                $incompletes = block_completion_progress_incomplete_count($activities, $completions, $this->config);
                ...
                $this->content->text .= block_completion_progress_zone_status($incompletes);
            }
            ...
            if (has_capability('block/completion_progress:overview', $this->context)) {
                $this->content->text .= block_completion_progress_users_zones($activities, $COURSE, $this->config);
